...
module "notify_slack" {
  source = "github.com/terraform-aws-modules/terraform-aws-notify-slack.git?ref=v6.5.1"
  ...
  slack_channel     = terraform.workspace == "production" ? "#opg-digideps-team" : "#integrations-alerts"
  slack_username    = "aws"
  slack_emoji       = ":warning:"
}
