...
# @pytest.mark.skip(reason="File system structure different on CI")
def test_get_encoded_s3_object():
    ...
    with mock_s3():
        ...
        result = get_encoded_s3_object(
            s3_client=s3_client, bucket="valid_bucket", key="test_file_on_aws.txt"
        )
