...
from lambda_functions.v2.functions.supporting_docs.app import sirius_service
from lambda_functions.v2.functions.supporting_docs.app import supporting_docs
